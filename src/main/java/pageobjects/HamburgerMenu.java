...
public class HamburgerMenu extends Setup {
	...
	private MobileElement helloSignIn() {
		return (MobileElement) driver.findElement(By.id("com.amazon.mShop.android.shopping:id/gno_greeting_text_view"));
	}
	...
	private MobileElement continueButton() {
		return (MobileElement) driver.findElement(By.xpath("//android.widget.Button[@text='Continue']"));
	}
}
