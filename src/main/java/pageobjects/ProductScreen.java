...
public class ProductScreen extends Setup {
	...
	private MobileElement randomResult() {
		return (MobileElement) driver.findElement(By.xpath("//android.view.ViewGroup[@index='0']"));
	}

	private MobileElement name() {
		return (MobileElement) driver.findElement(By.xpath("//*[@resource-id='title_feature_div']"));
	}

	private MobileElement useMyCurrentLocarion() {
		return (MobileElement) driver.findElement(By.id("com.amazon.mShop.android.shopping:id/loc_ux_gps_auto_detect"));
	}

	private MobileElement allowPermission() {
		return (MobileElement) driver.findElement(By.id("com.android.packageinstaller:id/permission_allow_button"));
	}

	private MobileElement price() {
		return (MobileElement) driver.findElement(By.xpath("//*[@resource-id='atfRedesign_priceblock_priceToPay']"));
	}

	private MobileElement inches() {
		return (MobileElement) driver.findElement(By.id("com.amazon.mShop.android.shopping:id/glow_subnav_label"));
	}
	...
	private MobileElement prodcutDetails() {
		return (MobileElement) driver.findElement(By.xpath("//android.view.View[@text='FREE Delivery']"));
	}

	private MobileElement fromTheManufacturer() {
		return (MobileElement) driver.findElement(By.xpath("//android.view.View[@text='From the manufacturer']"));
	}

	private MobileElement addToCart() {
		return (MobileElement) driver.findElement(By.xpath("//*[@resource-id='add-to-cart-button']"));
	}

	private MobileElement addedToCart() {
		return (MobileElement) driver.findElement(By.id("com.amazon.mShop.android.shopping:id/atc-success"));
	}
}
